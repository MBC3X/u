...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " امبيسي"
SudosS = {1573309498}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "امبيسي"),data="delnamebot"}},
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "امبيسي"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "امبيسي"),"اني لقميل "..(redis:get(bot_id..":namebot") or "امبيسي"),(redis:get(bot_id..":namebot") or "امبيسي").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "امبيسي") then
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = 'MBC3 ',url="https://t.me/xMBC3"}},
}
}
...
local Text = "*- 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗆𝗒 𝖽𝖾𝖺𝗋 𝗍𝗈 𝗌𝗈𝗎𝗋𝖼𝖾 𝗆𝖻𝖼3 .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  MBC3',url="https://t.me/xMBC3"}},
{{text = '- 𝗈𝗐𝗇𝖾𝗋 𝗆𝖻𝖼3 .',url="https://t.me/xRRRx"}},
{{text = '- 𝖽𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 .',url="https://t.me/sSs_sSs"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/xMBC3&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
