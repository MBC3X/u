...
memUsedPrc=io.popen([[echo `AnGel -m | awk 'NR==2{printf "%sMB/%sMB ( %.2f% )\n", $3,$2,$3*100/$2 }'`]]):read('*a'):gsub('[\n\r]+', '')
-------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " انجل"
SudosS = {1573309498}
...
type = 'inline',
data = {
{{text = '𓏺 𝖲𝗈𝗎𝖱𝖼𝖾 AnGel . † . ',url="t.me/ZZZZZD"}},
}
}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "انجل"),data="delnamebot"}},
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "انجل"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "انجل"),"اني لقميل "..(redis:get(bot_id..":namebot") or "انجل"),(redis:get(bot_id..":namebot") or "انجل").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "انجل") then
...
{{text = '- 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/ZZZZZD"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𓏺 𝖲𝗈𝗎𝖱𝖼𝖾 AnGel . † . ',url="https://t.me/ZZZZZD"}},
}
}
...
local Text = "*- WeLCoMe To SouRce AnGel  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𓏺 𝖲𝗈𝗎𝖱𝖼𝖾 AnGel . .',url="https://t.me/ZZZZZD"}},
{{text = ' 𓏺 ODIN .',url="https://t.me/xRRRx"}},
