...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " فري"
SudosS = {1573309498}
...
return {
by   = '\n*⌔ 𓏺 بواسطه : *'..UserInfousername..'\n'..TextMsg,
i   = '\n*⌔ 𓏺 المستخدم : *'..UserInfousername..'\n'..TextMsg,
yu    = '\n*⌔ 𓏺 عزيزي : *'..UserInfousername..'\n'..TextMsg
}
end
...
local Type  = infomsg[2]
if tonumber(data.sender_user_id) ~= tonumber(userid) then  
return bot.answerCallbackQuery(data.id,"⌔ 𓏺 عذرا الامر لا يخصك ", true)
end
if Type == "st" then  
...
t = "⌔ 𓏺 قائمه "..ty.." ."
if #Info_ == 0 then
return bot.answerCallbackQuery(data.id,"⌔ 𓏺 قائمه "..ty.." فارغه .", true)
end  
...
bot.editMessageText(chat_id,msg_id,"* ⌔ 𓏺 تحوي قائمه المنع على\n⌔ 𓏺 الصور ( "..Photo.." )\n⌔ 𓏺 الكلمات ( "..Text.." )\n⌔ 𓏺 الملصقات ( "..Sticker.." )\n⌔ 𓏺 المتحركات ( "..Animation.." )\n⌔ 𓏺 اضغط على القائمه المراد حذفها .*", 'md', true, false, reply_markup)
...
type = 'inline',
data = {
{{text = '⌔ 𓏺 FSouRce Free .',url="t.me/ourFREE"}},
}
}
if redis:get(bot_id..'Set:array'..user_id..':'..chat_id) == 'true1' then
redis:del(bot_id..'Set:array'..user_id..':'..chat_id)
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 تم حفظ الردود بنجاح .*", 'md', true, false, reply_markup)
else
bot.editMessageText(chat_id,msg_id," *⌔ 𓏺 تم تنفيذ الامر سابقا .*", 'md', true, false, reply_markup)
end
end
if Text and Text:match("^Sur_(.*)_(.*)") then
local infomsg = {Text:match("^Sur_(.*)_(.*)")}
if tonumber(data.sender_user_id) ~= tonumber(infomsg[1]) then  
bot.answerCallbackQuery(data.id, "⌔ 𓏺 الامر لا يخصك", true)
return false
end   
...
bot.editMessageText(chat_id,msg_id,"* ⌔ 𓏺 لا يمتلك البوت صلاحيه حظر الاعضاء .*", 'md', true, false, reply_markup)
return false
end   
if not Isrank(data.sender_user_id,chat_id) then
t = "*⌔ 𓏺 لا يمكن للبوت حظر "..Get_Rank(data.sender_user_id,chat_id).." .*"
else
t = "*⌔ 𓏺 تم طردك بنجاح .*"
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 تم الغاء عمليه الطرد بنجاح .*", 'md', true, false, reply_markup)
end
end
...
{{text = '⌔ 𓏺 الاوامر الرئيسيه',data="Amr_"..data.sender_user_id.."_5"}},
}
}
if infomsg[2] == '1' then
reply_markup = reply_markup
t = "*⌔ 𓏺 اوامر الحمايه اتبع مايلي .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 قفل ، فتح ← الامر .\n⌔ 𓏺 تستطيع قفل حمايه كما يلي .\n⌔ 𓏺 ( بالتقيد ، بالطرد ، بالكتم ، بالتقييد ) .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 تاك .\n⌔ 𓏺 القناه .\n⌔ 𓏺 الصور .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 الفشار .\n⌔ 𓏺 الموقع .\n⌔ 𓏺 التكرار .\n⌔ 𓏺 الفيديو .\n⌔ 𓏺 الدخول .\n⌔ 𓏺 الاضافه .\n⌔ 𓏺 الاغاني .\n⌔ 𓏺 الصوت .\n⌔ 𓏺 الملفات .\n⌔ 𓏺 الرسائل .\n⌔ 𓏺 الدردشه .\n⌔ 𓏺 الجهات .\n⌔ 𓏺 السيلفي .\n⌔ 𓏺 التثبيت .\n⌔ 𓏺 الشارحه .\n⌔ 𓏺 الكلايش .\n⌔ 𓏺 البوتات .\n⌔ 𓏺 التوجيه .\n⌔ 𓏺 التعديل .\n⌔ 𓏺 الانلاين .\n⌔ 𓏺 المعرفات .\n⌔ 𓏺 الكيبورد .\n⌔ 𓏺 الفارسيه .\n⌔ 𓏺 الانكليزيه .\n⌔ 𓏺 الاستفتاء .\n⌔ 𓏺 الملصقات .\n⌔ 𓏺 الاشعارات .\n⌔ 𓏺 الماركداون .\n⌔ 𓏺 المتحركات .*"
elseif infomsg[2] == '2' then
reply_markup = reply_markup
t = "*⌔ 𓏺 اعدادات المجموعه .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 الترحيب .\n⌔ 𓏺 مسح الرتب .\n⌔ 𓏺 الغاء التثبيت .\n⌔ 𓏺 فحص البوت .\n⌔ 𓏺 تعين الرابط .\n⌔ 𓏺 مسح الرابط .\n⌔ 𓏺 تغيير الايدي .\n⌔ 𓏺 تعين الايدي .\n⌔ 𓏺 مسح الايدي .\n⌔ 𓏺 مسح الترحيب .\n⌔ 𓏺 صورتي .\n⌔ 𓏺 تغيير اسم المجموعه .\n⌔ 𓏺 تعين قوانين .\n⌔ 𓏺 تغيير الوصف .\n⌔ 𓏺 مسح القوانين .\n⌔ 𓏺 تنظيف التعديل .\n⌔ 𓏺 تنظيف الميديا .\n⌔ 𓏺 مسح الرابط .\n⌔ 𓏺 رفع الادمنيه .\n⌔ 𓏺 تعين ترحيب .\n⌔ 𓏺 الترحيب .\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 المجموعه .*"
elseif infomsg[2] == '3' then
reply_markup = reply_markup
t = "*⌔ 𓏺 اوامر التفعيل والتعطيل .\n⌔ 𓏺 تفعيل/تعطيل الامر اسفل .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 اوامر التسليه .\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 الطرد .\n⌔ 𓏺 الحظر .\n⌔ 𓏺 الرفع .\n⌔ 𓏺 المميزات .\n⌔ 𓏺 المسح التلقائي .\n⌔ 𓏺 ٴall .\n⌔ 𓏺 منو ضافني .\n⌔ 𓏺 تفعيل الردود .\n⌔ 𓏺 الايدي بالصوره .\n⌔ 𓏺 الايدي .\n⌔ 𓏺 التنظيف .\n⌔ 𓏺 الترحيب .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 البايو .\n⌔ 𓏺 صورتي .\n⌔ 𓏺 الالعاب .*"
elseif infomsg[2] == '4' then
reply_markup = reply_markup
t = "*⌔ 𓏺 اوامر اخرى .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 المجموعه .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 اسمي .\n⌔ 𓏺 ايديي .\n⌔ 𓏺 مسح نقاطي .\n⌔ 𓏺 نقاطي .\n⌔ 𓏺 مسح رسائلي .\n⌔ 𓏺 رسائلي .\n⌔ 𓏺 مسح جهاتي .\n⌔ 𓏺 مسح بالرد .\n⌔ 𓏺 تفاعلي .\n⌔ 𓏺 جهاتي .\n⌔ 𓏺 مسح سحكاتي .\n⌔ 𓏺 سحكاتي .\n⌔ 𓏺 رتبتي .\n⌔ 𓏺 معلوماتي .\n⌔ 𓏺 المنشئ .\n⌔ 𓏺 رفع المنشئ .\n⌔ 𓏺 البايو/نبذتي .\n⌔ 𓏺 التاريخ/الساعه .\n⌔ 𓏺 رابط الحذف .\n⌔ 𓏺 الالعاب .\n⌔ 𓏺 منع بالرد .\n⌔ 𓏺 منع .\n⌔ 𓏺 تنظيف + عدد .\n⌔ 𓏺 قائمه المنع .\n⌔ 𓏺 مسح قائمه المنع .\n⌔ 𓏺 مسح الاوامر المضافه .\n⌔ 𓏺 الاوامر المضافه .\n⌔ 𓏺 ترتيب الاوامر .\n⌔ 𓏺 اضف امر .\n⌔ 𓏺 حذف امر .\n⌔ 𓏺 اضف رد .\n⌔ 𓏺 حذف رد .\n⌔ 𓏺 ردود المدير .\n⌔ 𓏺 مسح ردود المدير .\n⌔ 𓏺 الردود المتعدده .\n⌔ 𓏺 مسح الردود المتعدده .\n⌔ 𓏺 وضع عدد المسح +رقم .\n⌔ 𓏺 مسح البوتات .\n⌔ 𓏺 ٴall .\n⌔ 𓏺 غنيلي، فلم ، متحركه ، رمزيه ، فيديو .\n⌔ 𓏺 تغير رد العضو ، المميز ، الادمن ، المدير ، المنشئ ، المنشئ الاساسي. المالك ، المطور .\n⌔ 𓏺 حذف رد العضو ، المميز ، الادمن ، المدير ، المنشئ المنشئ الاساسي ، المالك المطور .*"
...
t = "*⌔ 𓏺 قائمه الاوامر .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 م1 اوامر الحمايه .\n⌔ 𓏺 م2 اوامر إعدادات المجموعه .\n⌔ 𓏺 م3 اوامر القفل والفتح .\n⌔ 𓏺 م4 اوامر اخرى .*"
end
bot.editMessageText(chat_id,msg_id,t, 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 اعدادات المجموعه  .*", 'md', true, false, reply_markup)
end
...
type = 'inline',data = {
	{{text = '⌔ 𓏺 الاحصائيات .',data="indfo"}},
 {{text = '⌔ 𓏺 تغيير المطور الاساسي .',data="EditDevbot"}},
{{text = '⌔ 𓏺 تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "فري"),data="delnamebot"}},
{{text = '⌔ 𓏺 تغيير كليشه ستارت .',data="addstarttxt"},{text ="⌔ 𓏺 حذف كليشه ستارت .",data="Deltxtstart"}},
{{text = '⌔ 𓏺 تنظيف المشتركين .',data="clenMsh"},{text ="⌔ 𓏺 تنظيف المجموعات .",data="clenMg"}},
...
{{text = '⌔ 𓏺 الاشتراك الاجباري .',data="chatmem"},{text = '⌔ 𓏺 الاذاعه .',data="sendtomem"}},
{{text = '⌔ 𓏺 مسح المطورين .',data="deldev"},{text ="⌔ 𓏺 مسح الثانويين .",data="delpor"}},
{{text = '⌔ 𓏺 المطورين .',data="lsdev"},{text ="⌔ 𓏺 الثانويين .",data="lspor"}},
{{text = '⌔ 𓏺 مسح المكتومين عام .',data="delmu"},{text ="⌔ 𓏺 مسح المحظورين عام .",data="delbnal"}},
{{text = '⌔ 𓏺 المكتومين عام .',data="lsmu"},{text ="⌔ 𓏺 المحظورين عام .",data="lsbnal"}},
{{text = '⌔ 𓏺 جلب نسخه احتياطيه .',data="GetfJson"},{text = '⌔ 𓏺 رفع نسخه احتياطيه .',data="UpfJson"}},
                {{text = '⌔ 𓏺 تحديث .',data="UpBot"},{text = '⌔ 𓏺 تحديث السورس .',data="UpSu"}},
{{text = '⌔ 𓏺 FSouRce Free .',url="t.me/ourFREE"}},
}
}
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*", 'md', true, false, reply_dev)
end
if Text == "UpfJson" then
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 رجوع',data="Can"}},
}
}
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم بأعاده ارسال الملف الخاص بالنسخه .*", 'md', true, false, reply_markup)
redis:set(bot_id..":set:"..chat_id..":UpfJson",true) 
end
if Text == "GetfJson" then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 جار ارسال النسخه .", true)
...
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لم يتم وضع اشتراك في البوت .", true)
return false
end
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 تم حذف البوت بنجاح .*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم برفع البوت ادمن في قناتك ثم قم بأرسل توجيه من القناه الى البوت .*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 الاشتراك الاجباري على القناه اسفل :*", 'md', true, false, reply_dev)
end
if Text == "indfo" then
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 اهلا بك في قسم الاحصائيات \n *ٴ━═━═━═━═━═━═━═━*\n⌔ 𓏺 عدد المشتركين ( "..user_id.." ) عضو \n⌔ 𓏺 عدد المجموعات ( "..Groups.." ) مجموعه *", 'md', true, false, reply_dev)
end
if Text == "chatmem" then
reply_dev = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 اضف اشتراك .',data="addCh"},{text ="⌔ 𓏺 حذف اشتراك .",data="Delch"}},
{{text = '⌔ 𓏺 الاشتراك .',data="TheCh"}},
{{text = '⌔ 𓏺 رجوع .',data="Can"}},
}
}
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 اهلا بك في لوحه اوامر الاشتراك الاجباري*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم الان بأرسل ايدي المطور الجديد .*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم الان بأرسل كليشه ستارت الجديده*", 'md', true, false, reply_markup)
...
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد محظورين بالبوت", true)
return false
end  
...
if Text == 'lsmu' then
t = '\n*⌔ 𓏺 قائمه المكتومين عام .\n   ٴ━═━═━═━═━═━═━═━*\n'
local Info_ = redis:smembers(bot_id..":bot:silent") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد مكتومين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
local Info_ = redis:smembers(bot_id..":bot:Ban")
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد محظورين في البوت", true)
return false
end  
redis:del(bot_id..":bot:Ban")
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم مسح المحظورين بنجاح", true)
end
if Text == "delmu" then
local Info_ = redis:smembers(bot_id..":bot:silent")
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد مكتومين في البوت ", true)
return false
end  
redis:del(bot_id..":bot:silent")
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم مسح المكتومين بنجاح", true)
end
if Text == 'lspor' then
t = '\n*⌔ 𓏺 قائمه الثانويين .\n   ٴ━═━═━═━═━═━═━═━*\n'
local Info_ = redis:smembers(bot_id..":Status:programmer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد ثانويين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد مطورين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if Text == "UpSu" then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم تحديث السورس", true)
...
if Text == "UpBot" then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم تحديث البوت", true)
dofile("start.lua")
end
...
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم حذف اسم البوت بنجاح", true)
end
...
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم الان بأرسل اسم البوت الجديد*", 'md', true, false, reply_markup)
redis:set(bot_id..":set:"..chat_id..":namebot",true) 
end
if Text == "delpor" then
local Info_ = redis:smembers(bot_id..":Status:programmer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد ثانويين في البوت", true)
return false
end
redis:del(bot_id..":Status:programmer") 
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم مسح الثانويين بنجاح", true)
end
if Text == "deldev" then
local Info_ = redis:smembers(bot_id..":Status:developer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "⌔ 𓏺 لا يوجد مطورين في البوت", true)
return false
end
redis:del(bot_id..":Status:developer") 
bot.answerCallbackQuery(data.id, "⌔ 𓏺 تم مسح المطورين بنجاح", true)
end
...
return bot.editMessageText(chat_id,msg_id,'*⌔ 𓏺 العدد الكلي ( '..#list..' )\n⌔ 𓏺 تم العثور على ( '..x..' ) من المشتركين الوهميين*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*⌔ 𓏺 العدد الكلي ( '..#list.." )\n⌔ 𓏺 لم يتم العثور على وهميين*", 'md', true, false, reply_dev)
end
end
if Text == "clenMg" then
local list = redis:smembers(bot_id..":Groups")   
...
x = x + 1
bot.sendText(Get_Chat.id,0,'*⌔ 𓏺 البوت ليس ادمن في المجموعه*',"md")
...
return bot.editMessageText(chat_id,msg_id,'*⌔ 𓏺 العدد الكلي ( '..#list..' )\n⌔ 𓏺 تم العثور على ( '..x..' ) من المجموعات الوهميه*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*⌔ 𓏺 العدد الكلي ( '..#list.." )\n⌔ 𓏺 لم يتم العثور على مجموعات وهميه*", 'md', true, false, reply_dev)
end
end
if Text == "sendtomem" then
reply_dev = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 رساله للكل .',data="AtSer_Tall"},{text ="⌔ 𓏺 توجيه للكل .",data="AtSer_Fall"}},
{{text = '⌔ 𓏺 رساله للمجموعات .',data="AtSer_Tgr"},{text ="⌔ 𓏺 توجيه للمجموعات .",data="AtSer_Fgr"}},
{{text = '⌔ 𓏺 رساله للاعضاء .',data="AtSer_Tme"},{text ="⌔ 𓏺 توجيه للاعضاء .",data="AtSer_Fme"}},
{{text = '⌔ 𓏺 رجوع',data="Can"}},
}
}
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 اوامر الاذاعه الخاصه بالبوت*", 'md', true, false, reply_dev)
end
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 الغاء .',data="Can"}},
}
}
redis:setex(bot_id..":set:"..chat_id..":send",600,iny)  
bot.editMessageText(chat_id,msg_id,"*⌔ 𓏺 قم الان بأرسال الرساله *", 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
end
end
...
if TrS == "Fall" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم توجيه الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه )  .*","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Fgr" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم توجيه الرساله الى ( "..#list.." مجموعه )  .*","md",true)      
for k,v in pairs(list) do  
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,false,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
redis:del(bot_id..":count:true") 
elseif TrS == "Fme" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم توجيه الرساله الى ( "..#lis.." عضو )  .*","md",true)      
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم ارسال الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه )  .*","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tgr" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم ارسال الرساله الى ( "..#list.." مجموعه )  .*","md",true)      
for k,v in pairs(list) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tme" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم ارسال الرساله الى ( "..#lis.." عضو )  .*","md",true)      
for k,v in pairs(lis) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
return bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 عذرا الملف هذا ليس للبوت*',"md")
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم رفع النسخه بنجاح*","md")
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذرا يجب عليك ارسل توجيه من قناه فقط .*","md")
return false
end     
sm = bot.getChatMember(id_chat,bot_id)
if sm.status.luatele == "chatMemberStatusAdministrator" then
redis:set(bot_id..":TheCh",id_chat) 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ القناه بنجاح  .*","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 البوت ليس مشرف بالقناه .*","md", true)
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تغيير المطور الاساسي بنجاح .*","md", true)
dofile("start.lua")
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس .*","md", true, false, false, false, reply_dev)
end
end
...
if text == "/start" then 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس .*","md", true, false, false, false, bot.replyMarkup{
type = 'inline',data = {
	{{text = '⌔ 𓏺 الاحصائيات .',data="indfo"}},
	{{text = '⌔ 𓏺 تغيير المطور الاساسي .',data="EditDevbot"}},
{{text = '⌔ 𓏺 تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "فري"),data="delnamebot"}},
...
bot.sendText(sudoid,0,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 قام بدخول الى البوت عدد اعضاء البوت الان ( "..scarduser_id.." ) .*").i,"md",true)
end
end
redis:sadd(bot_id..":user_id",msg.sender.user_id)  
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 لـ تنصيب البوتات .',url="https://t.me/sSs_sSs"}},
{{text = '⌔ 𓏺 اضفني الى مجموعتك .',url="https://t.me/"..bot.getMe().username.."?startgroup=new"}},
{{text = '⌔ 𓏺 FSouRce Free .',url="t.me/ourFREE"}},
}
}
...
r ="*⌔ 𓏺 اهلا بك عزيزي انا فري .\n⌔ 𓏺 لحمايه المجموعات ومميزات خدميه اخرى .\n⌔ 𓏺 ارفعي مشرف في كروبك وارسل تفعيل .\n⌔ 𓏺 سيتم رفع المالك والادمنيه تلقائيا .*"
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*⌔ 𓏺 تم ارسال رسالتك الى المطور*').yu,"md",true)
...
bot.sendText(IdSudo,0,Reply_Status(msg.sender.user_id,'*⌔ 𓏺 قام بارسال الملصق*').i,"md",true)  
return false
end
else
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*⌔ 𓏺 انت محظور من البوت*').yu,"md",true)  
end
end
end
end
...
if text == 'حظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*⌔ 𓏺 تم حظره بنجاح*').i,"md",true)
redis:sadd(bot_id.."banTo",id_user)  
return false  
end 
if text =='الغاء الحظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*⌔ 𓏺 تم الغاء حظره بنجاح*').i,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(id_user,'*⌔ 𓏺 تم ارسال رسالتك اليه*').i,"md",true)  
end
end
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم قفل التوجيه في المجموعه .*").yu,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 قام بالتكرار في المجموعه وتم حظره .*").yu,"md",true)
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 قام بالتكرار في المجموعه وتم تقييده .*").yu,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 قام بالتكرار في المجموعه وتم كتمه .*").yu,"md",true)  
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 التثبيت معطل من قبل المدراء .*","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الرد العام بنجاح .*","md",true)
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بارسال الرد العام .*","md",true)
return false
end
if text == "اضف رد عام" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الان الكلمه لاضافتها في ردود المطور .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حذف الرد العام بنجاح .*","md",true)
end
end
if text == "حذف رد عام" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الان الكلمه لحذفها من ردود المطور .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم منع الكلمه سابقا .*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم منع الملصق سابقا .*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم منع المتحركه سابقا .*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم منع الصوره سابقا .*","md",true)
return false
end
redis:sadd(bot_id.."mn:content:Photo"..msg.chat_id,msg.content.photo.sizes[1].photo.remote.unique_id)  
ty = "الصوره"
end
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم منع "..ty.." بنجاح .*","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الرد بنجاح .*","md",true)
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم المغادره من المجموعه .*","md",true)
...
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تحديث السورس بنجاح .*","md",true)
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/MBC3X/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تحديث جميع الملفات بنجاح .*","md",true)
dofile("start.lua")
end 
end
if Constructor(msg) then
if text == ("مسح ردود المدير") then
ext = "*⌔ 𓏺 تم مسح قائمه ردود المدير .*"
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الامر بنجاح .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم الان بأرسال الامر الجديد .*","md",true)  
return false
end
end
if text == "حذف امر" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بأرسال الامر الجديد الان .*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Command:del",true)
end
if text == "اضف امر" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم الان بأرسال الامر القديم .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بارسال الرد الذي تريد اضافته .*","md",true)
return false
end
if text == "اضف رد" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الان الكلمه لاضافتها في الردود .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حذف الرد بنجاح .*","md",true)  
end
end
if text == "حذف رد" or text == "مسح رد" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الان الكلمه لحذفها من الردود .*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Rp:del",true)
end
if text == ("ردود المدير") then
local list = redis:smembers(bot_id.."List:Rp:content"..msg.chat_id)
ext = "⌔ 𓏺 قائمه ردود المدير\n ٴ━═━═━═━═━═━═━═━ \n"
for k,v in pairs(list) do
if redis:get(bot_id.."Rp:content:Animation"..msg.chat_id..":"..v) then
db = "متحركه 🎭"
elseif redis:get(bot_id.."Rp:content:VoiceNote"..msg.chat_id..":"..v) then
...
if #list == 0 then
ext = "⌔ 𓏺 عذرا لا يوجد ردود في المجموعه ."
end
bot.sendText(msg.chat_id,msg.id,"["..ext.."]","md",true)  
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم مسح الاوامر بنجاح .*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الكلمه الرد الذي تريد اضافتها .*","md",true)  
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,' *⌔ 𓏺 تم حفظ الرد يمكنك ارسال اخر او اكمال العمليه من خلال الزر اسفل ✅*',"md",true, false, false, false, reply_ad)
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لا يوجد رد متعدد* ","md",true)  
return false
end
redis:srem(bot_id.."Add:Rd:array:Text"..gery..msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,' *⌔ 𓏺 تم حذفه بنجاح* ',"md",true)  
end
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,' *⌔ 𓏺 قم بارسال الرد الذي تريد حذفه منه* ',"md",true)  
return false
end
end
if text == "حذف رد من متعدد" and Owner(msg) then
redis:set(bot_id.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id,"delrd")
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الكلمه الرد الاصليه .*","md",true)  
return false
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حذف الرد المتعدد بنجاح .*","md",true)  
return false
end
end
...
t = Reply_Status(msg.sender.user_id,"\n *ٴ━═━═━═━═━═━═━═━ *\n*⌔ 𓏺 قائمه الردود المتعدده*\n  *ٴ━═━═━═━═━═━═━═━ *\n").yu
for k,v in pairs(list) do
t = t..""..k..">> ("..v..") » {رساله}\n"
end
if #list == 0 then
t = "*⌔ 𓏺 لا يوجد ردود متعدده .*"
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم مسح الردود المتعدده .*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم ترتيب الاوامر بالشكل التالي . \n⌔ 𓏺 تفعيل الايدي بالصوره - تفع . \n⌔ 𓏺 تعطيل الايدي بالصوره - تعط . \n⌔ 𓏺 رفع مطور ثانوي - ثانوي . \n⌔ 𓏺 رفع مطور - مط . \n⌔ 𓏺 رفع منشئ اساسي - اس . \n⌔ 𓏺 رفع منشئ - من . \n⌔ 𓏺 رفع مدير - مد . \n⌔ 𓏺 رفع ادمن - اد . \n⌔ 𓏺 رفع مميز - م . \n⌔ 𓏺 تنزيل الكل - تك . \n⌔ 𓏺 تغير الايدي - تغ . \n⌔ 𓏺 تاك للكل - تاك . \n⌔ 𓏺 تثبيت - ت . \n⌔ 𓏺 الرابط - ر . \n⌔ 𓏺 مسح رسائلي - رس . \n⌔ 𓏺 مسح سحكاتي - سح . \n⌔ 𓏺 مسح المكتومين - ،، . \n⌔ 𓏺 اضف رد - رد . \n⌔ 𓏺 غنيلي - غ . \n⌔ 𓏺 شعر - ش . \n⌔ 𓏺 ميمز - مم . \n⌔ 𓏺 ريمكس - رم . \n⌔ 𓏺 راب - ب . \n⌔ 𓏺 ردود المدير - رر .*","md",true)
end
end
if text == "اوامر التسليه" or text == "اوامر التسلية" then    
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اوامر التسليه هي .\nٴ━═━═━═━═━═━═━═━\n⌔ 𓏺 مصه . \n⌔ 𓏺 بوسه . \n⌔ 𓏺 هينه . \n⌔ 𓏺 رزلها . \n⌔ 𓏺 هينها . \n⌔ 𓏺 شنو رئيك بهذا . \n⌔ 𓏺 شنو رئيك بهاي . \n⌔ 𓏺 كت تويت .*","md",true)
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 البوت لا يمتلك صلاحيه حظر الاعضاء* ',"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حظر ( "..i.." ) من البوتات في المجموعه .*","md",true)  
end
if text == 'البوتات' then  
local Info = bot.searchChatMembers(msg.chat_id, " .*", 200)
local members = Info.members
ls = "*⌔ 𓏺 قائمه البوتات في المجموعه\n  *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 العلامه 《 *★ * 》 تدل على ان البوت مشرف*\n *ٴ━═━═━═━═━═━═━═━ *\n"
i = 0
for k, v in pairs(members) do
UserInfo = bot.getUser(v.member_id.user_id) 
if UserInfo.type.luatele == "userTypeBot" then 
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قائمه الاوامر .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 م1 اوامر الحمايه .\n⌔ 𓏺 م2 اوامر إعدادات المجموعه .\n⌔ 𓏺 م3 اوامر القفل والفتح .\n⌔ 𓏺 م4 اوامر اخرى.*","md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اوامر الحمايه اتبع مايلي .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 قفل ، فتح ← الامر .\n← تستطيع قفل حمايه كما يلي .\n← { بالتقيد ، بالطرد ، بالكتم ، بالتقييد }\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 تاك . \n⌔ 𓏺 القناه .\n⌔ 𓏺 الصور .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 الفشار .\n⌔ 𓏺 الموقع .\n⌔ 𓏺 التكرار .\n⌔ 𓏺 التفليش .\n⌔ 𓏺 الاباحي .\n⌔ 𓏺 الكفر .\n⌔ 𓏺 الفيديو .\n⌔ 𓏺 الدخول .\n⌔ 𓏺 الاضافه .\n⌔ 𓏺 الاغاني .\n⌔ 𓏺 الصوت .\n⌔ 𓏺 الملفات .\n⌔ 𓏺 الرسائل .\n⌔ 𓏺 الدردشه .\n⌔ 𓏺 الجهات .\n⌔ 𓏺 السيلفي .\n⌔ 𓏺 التثبيت .\n⌔ 𓏺 الشارحه .\n⌔ 𓏺 الكلايش .\n⌔ 𓏺 البوتات .\n⌔ 𓏺 التوجيه .\n⌔ 𓏺 التعديل .\n⌔ 𓏺 الانلاين .\n⌔ 𓏺 المعرفات .\n⌔ 𓏺 الكيبورد .\n⌔ 𓏺 الفارسيه .\n⌔ 𓏺 الانكليزيه .\n⌔ 𓏺 الاستفتاء .\n⌔ 𓏺 الملصقات .\n⌔ 𓏺 الاشعارات .\n⌔ 𓏺 الماركداون .\n⌔ 𓏺 المتحركات .*","md",true)
elseif text == "م2" or text == "م٢" then    
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اعدادات المجموعه .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 مسح الرتب .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 مسح الرابط .\n⌔ 𓏺 وضع رابط .\n⌔ 𓏺 تعين الرابط .\n⌔ 𓏺 فحص البوت .\n⌔ 𓏺 الترحيب .\n⌔ 𓏺 مسح الترحيب .\n⌔ 𓏺 وضع ترحيب .\n⌔ 𓏺 تنظيف التعديل .\n⌔ 𓏺 تنظيف الميديا .\n⌔ 𓏺 مسح الميديا .\n⌔ 𓏺 تعين قوانين .\n⌔ 𓏺 مسح القوانين .\n⌔ 𓏺 وضع قوانين .\n⌔ 𓏺  تعين الايدي .\n⌔ 𓏺 مسح الايدي .\n⌔ 𓏺 تغير الايدي .\n⌔ 𓏺 تغيير اسم المجموعه .\n⌔ 𓏺 تغيير الوصف .\n⌔ 𓏺 رفع الادمنيه .\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 المجموعه .*","md",true)
elseif text == "م3" or text == "م٣" then    
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اوامر التفعيل والتعطيل .\n⌔ 𓏺 تفعيل/تعطيل الامر اسفل .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 اوامر التسليه .\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 الطرد .\n⌔ 𓏺 الحظر .\n⌔ 𓏺 الرفع .\n⌔ 𓏺 المميزات .\n⌔ 𓏺 المسح التلقائي .\n⌔ 𓏺 ٴall .\n⌔ 𓏺 منو ضافني .\n⌔ 𓏺 تفعيل الردود .\n⌔ 𓏺 الايدي بالصوره .\n⌔ 𓏺 الايدي .\n⌔ 𓏺 التنظيف .\n⌔ 𓏺 الترحيب .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 البايو .\n⌔ 𓏺 صورتي .\n⌔ 𓏺 الالعاب .*","md",true)
elseif text == "م4" or text == "م٤" then    
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اوامر اخرى .\n *ٴ━═━═━═━═━═━═━═━ *\n⌔ 𓏺 الالعاب الاحترافيه .\n⌔ 𓏺 المجموعه .\n⌔ 𓏺 الرابط .\n⌔ 𓏺 اسمي .\n⌔ 𓏺 ايديي .\n⌔ 𓏺 مسح نقاطي .\n⌔ 𓏺 نقاطي .\n⌔ 𓏺 مسح رسائلي .\n⌔ 𓏺 رسائلي .\n⌔ 𓏺 مسح جهاتي .\n⌔ 𓏺 مسح بالرد .\n⌔ 𓏺 تفاعلي .\n⌔ 𓏺 جهاتي .\n⌔ 𓏺 مسح سحكاتي .\n⌔ 𓏺 سحكاتي .\n⌔ 𓏺 رتبتي .\n⌔ 𓏺 معلوماتي .\n⌔ 𓏺 المنشئ .\n⌔ 𓏺 رفع المنشئ .\n⌔ 𓏺 البايو/نبذتي .\n⌔ 𓏺 التاريخ/الساعه .\n⌔ 𓏺 رابط الحذف .\n⌔ 𓏺 الالعاب .\n⌔ 𓏺 منع بالرد .\n⌔ 𓏺 منع .\n⌔ 𓏺 تنظيف + عدد .\n⌔ 𓏺 قائمه المنع .\n⌔ 𓏺 مسح قائمه المنع .\n⌔ 𓏺 مسح الاوامر المضافه .\n⌔ 𓏺 الاوامر المضافه .\n⌔ 𓏺 ترتيب الاوامر .\n⌔ 𓏺 اضف امر .\n⌔ 𓏺 حذف امر .\n⌔ 𓏺 اضف رد .\n⌔ 𓏺 حذف رد .\n⌔ 𓏺 ردود المدير .\n⌔ 𓏺 مسح الردود المتعدده .\n⌔ 𓏺 الردود المتعدده .\n⌔ 𓏺 وضع عدد المسح +رقم .\n⌔ 𓏺 ٴall .\n⌔ 𓏺 غنيلي،فلم، متحركه، فيديو، رمزيه،انمي،ريمكس،شعر،ميمز،راب .\n⌔ 𓏺 مسح ردود المدير .\n⌔ 𓏺 تغير رد العضو.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطو  .\n⌔ 𓏺 حذف رد العضو.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطور .*","md",true)
elseif text == "قفل الكل" or text == "قفل التفليش" or text == "قفل الاباحي" or text == "قفل الكفر" then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." .*").by,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم قفل "..text.." .*").by,"md",true)
redis:hset(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User","del")  
elseif text == "فتح التكرار" then 
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم فتح "..text.." .*").by,"md",true)
redis:hdel(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User")  
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." سابقا .*").yu,"md",true)  
else
redis:set(bot_id..":"..msg.chat_id..":settings:"..srt,setTyp)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." بنجاح .*").by,"md",true)  
end
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تعطيل اطردني بواسطه المدراء .*","md",true)  
end
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اضغط نعم لتأكيد الطرد .*","md", true, false, false, false, bot.replyMarkup{
type = 'inline',data = {{{text = '⌔ 𓏺 نعم .',data="Sur_"..msg.sender.user_id.."_1"},{text = '⌔ 𓏺 الغاء .',data="Sur_"..msg.sender.user_id.."_2"}},}})
end
...
local Text = '\n  *ٴ━═━═━═━═━═━═━═━ *\n'
if #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لا يوجد لاعبين .*","md",true)
return false
end  
for k, v in pairs(list) do 
Text = Text..k.."-  [" ..v.."] .\n"  
...
local list = redis:smembers(bot_id..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لم يكتمل العدد الكلي للاعبين .*","md",true)  
elseif #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذرا لم تقوم باضافه اي لاعب .*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الف مبروك يا* ["..UserName.."] *لقد فزت\n⌔ 𓏺 تم اضافه 3 نقاط لك\n⌔ 𓏺 للعب مره اخره ارسل ~ (* روليت )","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 المعرف* ["..text.." ] *موجود سابقا ارسل معرف لم يشارك .*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ المعرف (*["..text.."]*)\n⌔ 𓏺 تم اكمال العدد الكلي\n⌔ 𓏺 ارسل (نعم) للبدء .*","md",true)  
return false
end  
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ المعرف* (["..text.."])\n*⌔ 𓏺 تبقى "..CountUser.." لاعبين ليكتمل العدد\n⌔ 𓏺 ارسل المعرف التالي .*","md",true)  
return false
end 
if text and text:match("^(%d+)$") and redis:get(bot_id..":Start_Rolet:"..msg.chat_id..msg.sender.user_id) then
if text == "1" then
bot.sendText(msg.chat_id,msg.id," *⌔ 𓏺 لا استطيع بدء اللعبه بلاعب واحد فقط .*","md",true)
elseif text ~= "1" then
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم  بأرسال معرفات اللاعبين الان .*","md",true)
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙حزوره .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙معاني .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"\n*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙العكس .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙سمايل او سمايلات .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Smile")
end
end 
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"(⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙امثله .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Example")
end
end
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙الاسرع او ترتيب .*","md",true)  
end
end
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لقد فزت في اللعبه\n⌔ 𓏺 اللعب مره اخره وارسل︙المختلف .*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Difference")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يجب ان لا يكون الرقم المخمن اكبر من ( 20 )\n⌔ 𓏺  خمن رقم بين ال ( 1 و 20 ) .*","md",true)  
end 
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 خمنت الرقم صح\n⌔ 𓏺 تم اضافة ( 5 ) نقاط لك .*","md",true)
...
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:SADD")
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 خسرت في اللعبه\n⌔ 𓏺 حاول في وقت اخر\n⌔ 𓏺 كان الرقم الذي تم تخمينه ( "..GETNUM.." ) .*","md",true)  
else
return bot.sendText(msg.chat_id,msg.id,"* ⌔ 𓏺 تخمينك من باب الشرجي 😂💓\n ارسل رقم من جديد  .*","md",true)  
end
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل عدد اللاعبين للروليت .*","md",true)  
end
if text == "خمن" or text == "تخمين" then   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
Num = math.random(1,20)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate",Num)  
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اهلا بك عزيزي في لعبة التخمين \n⌔ 𓏺 ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n⌔ 𓏺 سيتم تخمين عدد ما بين ال (1 و 20 ) اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ .*","md",true)  
end
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆??📅📆📆")
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اسرع واحد يدز الاختلاف ~* ( ["..name.."] )","md",true)  
end
if text == "امثله" then
redis:del(bot_id..":"..msg.chat_id..":game:Example")
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اسرع واحد يكمل المثل~* ( ["..name.."] )","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"⌔ 𓏺 اسرع واحد يدز هاذا السمايل ?~ ( "..SM.."}","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"⌔ 𓏺 اسرع واحد يرتبها~ ( ["..name.."] )","md",true)  
end
if text == "حزوره" then
redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اسرع واحد يحل الحزوره*\n ( "..name.." )","md",true)  
end
if text == "معاني" then
redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
...
return bot.sendText(msg.chat_id,msg.id,"⌔ 𓏺 اسرع واحد يدز معنى السمايل~ ( ["..name.."] )","md",true)  
end
if text == "العكس" then
redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اسرع واحد يدز العكس ~* ( ["..name.."])","md",true) 
end
end -- end tf
...
t = "*⌔ 𓏺 لم يتم وضع القوانين في المجموعه  .*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اطلق دخول عمري💘 :  .*"..Usertag..".","md")  
end
end
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 Press here .',url="t.me/sSs_BoT"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 Bot delete accounts 🗑️ .*',"md", true, false, false, false, reply_markup)
end
if text == 'همسه' or text == 'همسة' or text == 'بوت همسه' or text == 'بوت الهمسه' then
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 hiss .',url="t.me/sSs_BoT"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 Bot hiss 🔐 .*',"md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 Bot YouTube ⚙️ .*',"md", true, false, false, false, reply_markup)
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "فري"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "فري"),"اني لقميل "..(redis:get(bot_id..":namebot") or "فري"),(redis:get(bot_id..":namebot") or "فري").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "فري") then
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 التاريخ الان : ( "..os.date("%Y/%m/%d").." ) .*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 البوت لا يمتلك صلاحيه .*","md",true)  
return false
end
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم "..text.." بنجاح .*","md",true)  
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 "..text.." حساب محذوف .*","md",true)  
return false
end
if UserInfo.username and UserInfo.username ~= "" then
...
local TestText = "  *⌔ 𓏺 Name : *( "..(t).." *)*\n*⌔ 𓏺 User : *( "..(u).." *)*\n*⌔ 𓏺 Bio :* ["..GetBio(UserInfo.id).."]\n"
keyboardd = {}
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الاسم : *( "..(t).." *)*\n*⌔ 𓏺 المعرف : *( "..(u).." *)*\n["..GetBio(UserInfo.id).."]","md",true)  
end
end
end
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 ليس لدي صلاحيه تثبيت رسائل*',"md",true)  
return false
end
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تثبيت الرساله .*","md",true)
...
PermissionsUser = '*\n⌔ 𓏺 صلاحياتك هي :\n *ٴ━═━═━═━═━═━═━═━ *'..'\n⌔ 𓏺 تغيير المعلومات : '..change_info..'\n⌔ 𓏺 تثبيت الرسائل : '..pin_messages..'\n⌔ 𓏺 اضافه مستخدمين : '..invite_users..'\n⌔ 𓏺 مسح الرسائل : '..delete_messages..'\n⌔ 𓏺 حظر المستخدمين : '..restrict_members..'\n⌔ 𓏺 اضافه المشرفين : '..promote..'\n\n*'
end
end
...
bot.sendText(msg.chat_id,msg.id,'\n*⌔ 𓏺 ايديك : '..UserId..'\n⌔ 𓏺 معرفك : '..UserInfousername..'\n⌔ 𓏺 ‍رتبتك : '..Get_Rank..'\n⌔ 𓏺 موقعك : '..StatusmC..'\n⌔ 𓏺 رسائلك : '..messageC..'\n⌔ 𓏺 تعديلاتك : '..EditmessageC..'\n⌔ 𓏺 تفاعلك : '..Total_ms..'*'..(PermissionsUser or '') ,"md",true) 
end
...
theId = Description.."\n*⌔ 𓏺 الايدي : (* "..msg.sender.user_id.."* )\n⌔ 𓏺 المعرف :* ( "..UserInfousername.." )\n*⌔ 𓏺 الرتبه : (  "..Get_Rank.." )\n⌔ 𓏺 تفاعلك : (  "..Total_ms.." )\n⌔ 𓏺 عدد الرسائل : ( "..messageC.." )\n⌔ 𓏺 عدد السحكات : ( "..EditmessageC.." )\n⌔ 𓏺 عدد صورك : ( "..TotalPhoto.."* )"
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اليوزر ليس لحساب شخصي تأكد منه .*","md",true)  
return false
end
if UserId_Info.type.is_channel == true then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اليوزر لقناه او مجموعه تأكد منه .*","md",true)  
return false
end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذرا يجب ان تستخدم معرف لحساب شخصي فقط .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الايدي : *( "..(UserId_Info.id).." *)*\n*⌔ 𓏺 المعرف : *( [@"..(UserName).."] *)*\n*⌔ 𓏺 الرتبه : *( "..(Get_Rank(UserId_Info.id,msg.chat_id)).." *)*\n*⌔ 𓏺 الموقع : *( "..(gstatus).." *)*\n*⌔ 𓏺 عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserId_Info.id..":message") or 1).." *) .*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الايدي : *( "..(Remsg.sender.user_id).." *)*\n*⌔ 𓏺 المعرف : *( ["..(uame).."] *)*\n*⌔ 𓏺 الرتبه : *( "..(Get_Rank(Remsg.sender.user_id,msg.chat_id)).." *)*\n*⌔ 𓏺 الموقع : *( "..(gstatus).." *)*\n*⌔ 𓏺 عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..Remsg.sender.user_id..":message") or 1).." *) .*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الايدي : *( "..(UserName).." *)*\n*⌔ 𓏺 المعرف : *( ["..(uame).."] *)*\n*⌔ 𓏺 الرتبه : *( "..(Get_Rank(UserName,msg.chat_id)).." *)*\n*⌔ 𓏺 الموقع : *( "..(gstatus).." *)*\n*⌔ 𓏺 عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserName..":message") or 1).." *) .*" ,"md",true)  
end
if text == 'اوامر المسح' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = '⌔ 𓏺 مسح رسائلي .',data="delforme_"..msg.sender.user_id.."_1"}},
{{text ="⌔ 𓏺 مسح سحكاتي .",data="delforme_"..msg.sender.user_id.."_2"}},
{{text = '⌔ 𓏺 مسح جهاتي .',data="delforme_"..msg.sender.user_id.."_3"}},
{{text ="⌔ 𓏺 مسح نقاطي .",data="delforme_"..msg.sender.user_id.."_4"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 اهلا بك بأوامر المسح اضغط على الزر لحذفهن .*',"md", true, false, false, false, reply_markup)
end
...
type = 'inline',
data = {
{{text = '⌔ 𓏺 الرسائل .',data="iforme_"..msg.sender.user_id.."_1"},{text ="( "..nummsg.." )",data="iforme_"..msg.sender.user_id.."_1"}},
{{text = '⌔ 𓏺 السحكات .',data="iforme_"..msg.sender.user_id.."_2"},{text ="( "..edit.." )",data="iforme_"..msg.sender.user_id.."_2"}},
{{text = '⌔ 𓏺 الجهات .',data="iforme_"..msg.sender.user_id.."_3"},{text ="( "..addmem.." )",data="iforme_"..msg.sender.user_id.."_3"}},
{{text = '⌔ 𓏺 المجوهرات .',data="iforme_"..msg.sender.user_id.."_4"},{text ="( "..Num.." )",data="iforme_"..msg.sender.user_id.."_4"}},
}
}
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 اهلا بك احصائياتك هي ⬇️ .*","md", true, false, false, false, reply_markup)
return false
end
if text == 'رتبتي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 رتبتك : *( "..(Get_Rank(msg.sender.user_id,msg.chat_id)).." *) .*","md",true)  
return false
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عدد سحكاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage") or 0).." *) .*","md",true)  
return false
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم مسح جميع سحكاتك .*',"md",true)
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage")
return false
end
if text == 'جهاتي' or text == 'اضافاتي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عدد جهاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Addedmem") or 0).." *) .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 ليس لدي صلاحيه حذف رسائل .*',"md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم مسح جميع جهاتك .*',"md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 انت منشئ المجموعه .*","md",true) 
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم اضافتك بواسطه  : (  .*"..(Name).." *) .*","md",true)  
else
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قد قمت بالانضمام عبر الرابط .*","md",true) 
return false
end
end
if Constructor(msg) then
...
bot.sendText(msg.chat_id,msg.id,"\n*⌔ 𓏺 عذرآ تستطيع فقط استخدام الامر على المستخدمين*","md",true)  
return false
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*⌔ 𓏺 عذرآ لا تستطيع استخدام الامر على البوت*","md",true)  
return false
end
redis:incrby(bot_id..":"..msg.chat_id..":"..Remsg.sender.user_id..":game",string.match(text:match("^اضف نقاط (%d+)$"), "(%d+)"))  
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم اضافه ( "..string.match(text:match("^اضف نقاط (%d+)$"), "(%d+)").." ) رساله له .*").yu,"md",true)
return false
end
...
local UserInfo = bot.getUser(UserName)
if UserInfo.code == 400 or UserInfo.message == "Invalid user ID" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الايدي ليس لحساب شخصي تأكد منه .*","md",true)  
return false
end
redis:incrby(bot_id..":"..msg.chat_id..":"..UserName..":game",redis:get(bot_id..":"..msg.chat_id..":settings:game:"..msg.sender.user_id))  
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم اضافه ( "..redis:get(bot_id..":"..msg.chat_id..":settings:game:"..msg.sender.user_id).." ) رساله له .*").yu,"md",true)
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل معرف او ايدي الشخص الان .*","md",true)   
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم اضافه ( "..string.match(text:match("^اضف رسائل (%d+)$"), "(%d+)").." ) رساله له .*").yu,"md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم اضافه ( "..redis:get(bot_id..":"..msg.chat_id..":settings:addmsg:"..msg.sender.user_id).." ) رساله له .*").yu,"md",true)
...
if text == 'رسائلي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عدد رسائلك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message") or 1).." *)*","md",true)  
return false
end
if text == 'مسح رسائلي' then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم مسح جميع رسائلك .*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message")
return false
end
if text == 'نقاطي' or text == 'مجوهراتي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عدد نقاطك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game") or 0).." *)*","md",true)  
return false
end
if text and text:match("^بيع نقاطي (%d+)$") then  
local end_n = text:match("^بيع نقاطي (%d+)$")
if tonumber(end_n) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لا استطيع البيع اقل من 1 .*","md",true)  
return false 
end
if tonumber(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ليس لديك جواهر من الالعاب .\n⌔ 𓏺 اذا كنت تريد ربح الجواهر .\n⌔ 𓏺 ارسل الالعاب وابدأ اللعب ! .*","md",true)  
else
local nb = redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
if tonumber(end_n) > tonumber(nb) then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ليس لديك جواهر بهاذا العدد .\n⌔ 𓏺 لزيادة مجوهراتك في اللعبه .\n⌔ 𓏺 ارسل الالعاب وابدأ اللعب !*","md",true)  
return false
end
local end_d = string.match((end_n * 50), "(%d+)") 
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم خصم* *~ { "..end_n.." }* *من مجوهراتك* .\n*⌔ 𓏺 وتم اضافة* *~ { "..end_d.." }* *الى رسائلك .*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم مسح جميع نقاطك .*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
return false
end
if text == 'ايديي' then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ايديك : *( "..msg.sender.user_id.." *) .*","md",true)  
return false
end
if text == 'اسمي' and Administrator(msg) then
bot.sendText(msg.chat_id,msg.id," *⌔ 𓏺 اسمك : *( "..bot.getUser(msg.sender.user_id).first_name.." *) .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'\n*⌔ 𓏺 معلومات المجموعه :\n⌔ 𓏺 الايدي : ( '..msg.chat_id..' )\n⌔ 𓏺 عدد الاعضاء : '..Info_Chats.member_count..'\n⌔ 𓏺 عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔ 𓏺 عدد المطرودين : '..Info_Chats.banned_count..'\n⌔ 𓏺 عدد المقيدين : '..Info_Chats.restricted_count..'\n⌔ 𓏺 الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md",true, false, false, false, reply_markup)
return false
end
...
{{text = '⌔ 𓏺 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/ourFREE"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 قائمه الالعاب الاحترافيه اضغط للعب*',"md", true, false, false, false, reply_markup)
end
end
...
heen = {
"⌔ 𓏺 حبيبي علاج الجاهل التجاهل ."
,"⌔ 𓏺 مالي خلك زبايل التلي . "
,"⌔ 𓏺 كرامتك صارت بزبل פَــبي ."
,"⌔ 𓏺 مو صوجك صوج الكواد الزمك جهاز ."
,"⌔ 𓏺 لفارغ استجن . "
,"⌔ 𓏺 لتتلزك بتاجراسك ."
,"⌔ 𓏺 ملطلط دي ."
};
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يجب عمل رد على رساله شخص*","md", true)
return false
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if developer(Remsg) then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لا خاف عيب هذا مطوري*","md", true)
return false
end
...
if text == "احسب" then
local arr = {'⌔ 𓏺 115 ÷ 32 = ? .','⌔ 𓏺 44 × 64 = ? .','⌔ 𓏺 780 ÷ 13 = ? .','⌔ 𓏺 780 ÷ 13 = ? .','⌔ 𓏺 6 + 78 = ? .','⌔ 𓏺 10 × 19 = ? .','⌔ 𓏺 728 ÷ 11 = ? .','⌔ 𓏺 2484 × 548 = ? .','⌔ 𓏺 384 + 484 = ? .','⌔ 𓏺 4854 ÷ 38 = ? .','⌔ 𓏺 6933 - 830 = ? .','⌔ 𓏺1299 × 104 = ? .','⌔ 𓏺 992 - 74 = ? .','⌔ 𓏺 6192 + 592 = ? .','⌔ 𓏺 291 - 93 × 48 = ? .','⌔ 𓏺 132 ÷ 67 = ? . ','⌔ 𓏺 9210 + 682 = ? .','⌔ 𓏺 2100 × 30 = ? . '}
bot.sendText(msg.chat_id,msg.id,arr[math.random(#arr)],"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 لا توجد صوره في حسابك*',"md",true) 
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الرابط الجديد بنجاح .*","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذرا الرابط خطأ .*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الايدي الجديد بنجاح .*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ الترحيب الجديد بنجاح .*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 ليس لدي صلاحيات تغيير المعلومات*',"md",true)  
return false
end
bot.setChatTitle(msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تغيير الاسم بنجاح .*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تغيير الوصف بنجاح .*","md", true)
end
if BasicConstructor(msg) then
if text == 'تغيير اسم المجموعه' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":nameGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بارسال الاسم الجديد الان .*","md", true)
end
if text == 'تغيير الوصف' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":decGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بارسال الوصف الجديد الان .*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم حفظ القوانين بنجاح .*","md", true)
end
if Owner(msg) then
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بأرسال قائمه القوانين الان .*","md", true)
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then
redis:del(bot_id..":"..msg.chat_id..":Law")
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم "..text.." الجديد بنجاح  .*","md", true)
end
if text == "تنظيف التعديل" or text == "مسح التعديل" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم البحث عن الرسائل المعدله .*","md",true)
...
if y == 0 then 
t = "*⌔ 𓏺 لم يتم العثور على رسائل معدله ضمن 250 رساله السابقه .*"
else
t = "*⌔ 𓏺 تم حذف ( "..y.." ) من الرسائل المعدله  .*"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
if text == "تنظيف الميديا" or text == "مسح الميديا" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 يتم البحث عن الميديا .*","md",true)
msgid = (msg.id - (1048576*250))
y = 0
r = 1048576
for i=1,250 do
...
if y == 0 then 
t = "*⌔ 𓏺 لم يتم العثور على ميديا ضمن 250 رساله السابقه .*"
else
t = "*⌔ 𓏺 تم حذف ( "..y.." ) من الميديا  .*"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم رفع  ('..y..') ادمن بالمجموعه .*',"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 ارسل الترحيب الجديد الان .\n⌔ 𓏺 لتتمكن من اضافته .*\nٴ━═━═━═━═━═━═━═━\n⌔ 𓏺 user - *يوزر المستخدم .*\n⌔ 𓏺 name - *اسم المستخدم .*","md", true)
end
if text == 'الترحيب' then
if redis:get(bot_id..":"..msg.chat_id..":Welcome") then
t = redis:get(bot_id..":"..msg.chat_id..":Welcome")
else 
t = "*⌔ 𓏺 لم يتم وضع ترحيب .*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 FSouRce Free .',url="https://t.me/ourFREE"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 ارسل الايدي الجديد الان .\n⌔ 𓏺 لتتمكن من اضافته .*\n━═━═━═━═━═━═━═━\n⌔ 𓏺 #username - *اسم المستخدم .*\n⌔ 𓏺 #msgs - *عدد رسائل المستخدم .*\n⌔ 𓏺 #photos - *عدد صور المستخدم .*\n⌔ 𓏺 #id - *ايدي المستخدم .*\n⌔ 𓏺 #auto - *تفاعل المستخدم* .\n⌔ 𓏺 #stast - *موقع المستخدم .*\n⌔ 𓏺 #edit - *عدد السحكات .*\n⌔ 𓏺 #AddMem - *عدد الجهات .*\n⌔ 𓏺 #Description - *تعليق الصوره .*',"md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تغير كليشة الايدي .*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم بارسال الرابط الجديد الان .*","md", true)
end
if text == 'فحص البوت' then 
local StatusMember = bot.getChatMember(msg.chat_id,bot_id).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 البوت عضو في المجموعه*',"md",true) 
return false
end
local GetMemberStatus = bot.getChatMember(msg.chat_id,bot_id).status
if GetMemberStatus.can_change_info then
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 البوت ليس ادمن في المجموعه .*","md",true)  
return false
end
if GetInfoBot(msg).Delmsg == false then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 البوت لا يمتلك صلاحيه حذف الرسائل .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id, msg.id,"*⌔ 𓏺 تم تنظيف ( "..NumMessage.." ) رساله  .*", 'md')
end
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم "..text.." بنجاح .*","md", true)
end
if text and text:match("^تغير رد المطور (.*)$") then
local Teext = text:match("^تغير رد المطور (.*)$") 
redis:set(bot_id.."Reply:developer"..msg.chat_id,Teext)
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تغيير الرد بنجاح الى :  .*"..Teext.. "", 'md')
...
redis:del(bot_id..":Reply:developer"..msg.chat_id)
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم "..text.." بنجاح .*", 'md')
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم الغاء تثبيت جميع الرسائل المثبته .*","md",true)
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔ 𓏺 الصور .', data="mn_"..msg.sender.user_id.."_ph"},{text = '⌔ 𓏺 الكلمات .', data="mn_"..msg.sender.user_id.."_tx"}},
{{text = '⌔ 𓏺 المتحركات .', data="mn_"..msg.sender.user_id.."_gi"},{text = '⌔ 𓏺 الملصقات .',data="mn_"..msg.sender.user_id.."_st"}},
{{text = '⌔ 𓏺 تحديث .',data="mn_"..msg.sender.user_id.."_up"}},
{{text = '⌔ 𓏺 FSouRce Free .',url="https://t.me/ourFREE"}},
}
}
bot.sendText(msg.chat_id,msg.id,"* ⌔ 𓏺 تحوي قائمه المنع على .\n⌔ 𓏺 الصور ( "..Photo.." ) .\n⌔ 𓏺 الكلمات ( "..Text.." ) .\n⌔ 𓏺 الملصقات  ( "..Sticker.." )\n⌔ 𓏺 المتحركات  ( "..Animation.." ) .\n⌔ 𓏺 اضغط على القائمه المراد حذفها .\nٴ━═━═━═━═━═━═━═━ *","md",true, false, false, false, reply_markup)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 قم الان بارسال ( نص او الميديا ) لمنعه من المجموعه .*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم الغاء منع "..ty.." بنجاح .*","md",true)  
end
----------------------------------------------------------------------------------------------------
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 الايدي : *( `"..(usetid).."` *)*\n*⌔ 𓏺 الرتبه : *( `"..(Get_Rank(usetid,msg.chat_id)).."` *)*\n*⌔ 𓏺 الموقع : *( `"..(gstatus).."` *)*\n*⌔ 𓏺 عدد الرسائل : *( `"..(redis:get(bot_id..":"..msg.chat_id..":"..usetid..":message") or 1).."` *) .*" ,"md",true)  
end
end
if Administrator(msg)  then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 الطرد معطل بواسطه المنشئين الاساسيين .*").yu,"md",true)
return false
end
end
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 البوت لا يمتلك صلاحيه طرد الاعضاء* ',"md",true)  
return false
end
if not Norank(usetid,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك طرد "..Get_Rank(usetid,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم طرده بنجاح .*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*⌔ 𓏺 لا يمتلك رتبه بالفعل .*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*⌔ 𓏺 تم تنزيله بنجاح .*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 الرفع معطل بواسطه المنشئين الاساسيين .*").yu,"md",true)  
return false
end
end
if redis:sismember(bot_id..srt1.."Status:"..srt,usetid) then
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*⌔ 𓏺 تم رفعه سابقا .*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*⌔ 𓏺 تم رفعه بنجاح .*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*⌔ 𓏺 "..tt.." .*").yu,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 الكتم معطل بواسطه المنشئين الاساسيين .*").yu,"md",true)  
return false
end
end
if not Norank(usetid,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك كتم "..Get_Rank(usetid,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم كتمه بنجاح .*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 الحظر معطل بواسطه المنشئين الاساسيين .*").yu,"md",true)  
return false
end
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
...
if not Norank(usetid,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر "..Get_Rank(usetid,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,usetid,'banned',0)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 تم رفع القيود عنه .*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 تم رفع القيود عنه .*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 تم رفع القيود عنه .*").i,"md",true)  
return false
end
...
Banal = "⌔ 𓏺 الحظر العام : محظور بالفعل"
else
Banal = "⌔ 𓏺 الحظر العام : غير محظور"
end
if redis:sismember(bot_id..":bot:silent", UserId_Info.id) then
silental  = "⌔ 𓏺 كتم العام : مكتوم بالفعل"
else
silental = "⌔ 𓏺 كتم العام : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":restrict", UserId_Info.id) then
rict = "⌔ 𓏺 التقييد : مقيد بالفعل"
else
rict = "⌔ 𓏺 التقييد : غير مقيد"
end
if redis:sismember(bot_id..":"..msg.chat_id..":silent", UserId_Info.id) then
sent = "\n⌔ 𓏺 الكتم : مكتوم بالفعل"
else
sent = "\n⌔ 𓏺 الكتم : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":Ban", UserId_Info.id) then
an = "\n⌔ 𓏺 الحظر : محظور بالفعل"
else
an = "\n⌔ 𓏺 الحظر : غير محظور"
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 البوت لا يمتلك صلاحيه تقييد الاعضاء* ',"md",true)  
return false
end
if not Norank(UserName,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك تقييد "..Get_Rank(UserName,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم تقييده بنجاح .*"
...
t = "*⌔ 𓏺 لا يمكنك تقييد "..Get_Rank(UserId_Info.id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم تقييده بنجاح .*"
...
t = "*⌔ 𓏺 لا يمكنك تقييد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم تقييده بنجاح .*"
...
if not Norank(UserName,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك طرد "..Get_Rank(UserName,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم طرده بنجاح .*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك طرد "..Get_Rank(UserId_Info.id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم طرده بنجاح .*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك طرد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم طرده بنجاح .*"
...
if not Norank(UserName,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر "..Get_Rank(UserName,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر "..Get_Rank(UserId_Info.id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر "..Get_Rank(Remsg.sender.user_id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
if not Norank(UserName,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك كتم "..Get_Rank(UserName,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم كتمه بنجاح .*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك كتم "..Get_Rank(UserId_Info.id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم كتمه بنجاح .*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك كتم "..Get_Rank(Remsg.sender.user_id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم كتمه بنجاح .*"
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 لا يوجد "..text:gsub('ال',"").." .*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
t = t.." .*"..k.." ⌔ 𓏺 *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
else
t = t.." .*"..k.." ⌔ 𓏺* ["..v.."](tg://user?id="..v..")\n"
end
end
...
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Ban") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم حذف "..text:gsub('مسح',"").." سابقا .*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." بنجاح .*").yu,"md",true)  
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 البوت لا يمتلك صلاحيه حظر عام الاعضاء* ',"md",true)  
return false
end
if not Isrank(UserName,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر عام "..Get_Rank(UserName,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره عام بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Isrank(UserId_Info.id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر عام "..Get_Rank(UserId_Info.id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره عام بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Isrank(Remsg.sender.user_id,msg.chat_id) then
t = "*⌔ 𓏺 لا يمكنك حظر عام "..Get_Rank(Remsg.sender.user_id,msg.chat_id).." .*"
else
t = "*⌔ 𓏺 تم حظره عام بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم عمل تاك في المجموعه قبل قليل انتظر من فضلك .*","md",true) 
end
...
local members = Info.members
if #members <= 9 then
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 لا يوجد عدد كافي من الاعضاء .*","md",true) 
end
for k, v in pairs(members) do
local UserInfo = bot.getUser(v.member_id.user_id)
...
local Mesge = v
if Mesge then
t = "*⌔ 𓏺 تم مسح "..k.." من الوسائط تلقائيا\n⌔ 𓏺 يمكنك تعطيل الميزه بستخدام الامر ( تعطيل المسح التلقائي ) .*"
...
if redis:get(bot_id..":"..msg.chat_id..":settings:mediaAude") then
Text = Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." سابقا .*").yu
else
Text = Reply_Status(msg.sender.user_id,"*⌔ 𓏺 تم "..text.." بنجاح .*").by
...
t = "*⌔ 𓏺 تم تعيين  ( "..Teext.." ) كعدد للحذف التلقائي .*"
redis:set(bot_id..":mediaAude:utdl"..msg.chat_id,Teext)
else
t = "⌔ 𓏺 عذرا يجب كتابه ( وضع عدد المسح + رقم )"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)
end
if text == ("عدد الميديا") or text == ("الميديا") then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 عدد الميديا هو :  "..redis:scard(bot_id..":"..msg.chat_id..":mediaAude:ids").." .*").yu,"md",true)
end
--
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 "..tt.." .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 "..tt.." .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 "..tt.." .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 تم رفعه سابقا .*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 تم رفعه بنجاح .*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 تم رفعه سابقا .*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 تم رفعه بنجاح .*").i,"md",true)  
return false
end
end
if text and text:match("^رفع (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 تم رفعه سابقا .*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 تم رفعه بنجاح .*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 لا يمتلك رتبه بالفعل .*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*⌔ 𓏺 تم تنزيله بنجاح .*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 لا يمتلك رتبه بالفعل .*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*⌔ 𓏺 تم تنزيله بنجاح .*").i,"md",true)  
return false
end
end
if text and text:match("^تنزيل (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 لا يمتلك رتبه بالفعل .*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*⌔ 𓏺 تم تنزيله بنجاح .*").i,"md",true)  
return false
end
end
----------------------------------------------------------------------------------------------------
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 لا يوجد المالكين*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if redis:get(bot_id..":"..msg.chat_id..":Features") then
return bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 تم تعطيل المميزات بواسطه المدراء .*","md",true)  
end
keyboard = {} 
...
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/musicallybyfree/"..math.random(2,417).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الاغنيه لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/rteww0/"..math.random(2,169).."&caption="..URL.escape("⌔ 𓏺 تم اختيار شعر لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/werrtl/"..math.random(2,215).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الميمز لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/rderil/"..math.random(2,148).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الراب لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/erweri/"..math.random(2,215).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الريمكس لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/LKKKKT/"..math.random(2,78).."&caption="..URL.escape("⌔ 𓏺 تم ختيار الفيديو لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg.chat_id.."&animation=https://t.me/LKKKKR/"..math.random(2,143).."&caption="..URL.escape("⌔ 𓏺 تم اختيار المتحركه لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/RRRRRTQ/"..math.random(2,86).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الفلم لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/kartonn220/"..math.random(2,86).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الكارتون لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendPhoto?chat_id="..msg.chat_id.."&photo=https://t.me/zezesu/"..math.random(2,107).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الصوره لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendPhoto?chat_id="..msg.chat_id.."&photo=https://t.me/anmee344/"..math.random(2,107).."&caption="..URL.escape("⌔ 𓏺 تم اختيار الصوره لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local Text = "*𓏺 𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝖲𝗈𝗎𝖱𝖼𝖾 𝖥𝗋𝖾𝖾 .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذراً البوت ليس ادمن في المجموعه .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذراً يجب أنْ تكون مشرف او مالك المجموعه .*","md",true)  
return false
end
end
if sm.status.luatele == "chatMemberStatusCreator" then
...
if redis:sismember(bot_id..":Groups",msg.chat_id) then
 bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم تفعيل المجموعه سابقا* .',"md",true)  
return false
else
Get_Chat = bot.getChat(msg.chat_id)
Info_Chats = bot.getSupergroupFullInfo(msg.chat_id)
...
bot.sendText(sudoid,0,'*\n⌔ 𓏺 تم تفعيل مجموعه جديده \n⌔ 𓏺 بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n⌔ 𓏺 معلومات المجموعه :\n⌔ 𓏺 عدد الاعضاء : '..Info_Chats.member_count..'\n⌔ 𓏺 عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔ 𓏺 عدد المطرودين : '..Info_Chats.banned_count..'\n⌔ 𓏺 عدد المقيدين : '..Info_Chats.restricted_count..'\n⌔ 𓏺 الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم تفعيل المجموعه بنجاح .*',"md", true, false, false, false, reply_markup)
...
if not developer(msg) then
if sm.status.luatele ~= "chatMemberStatusCreator" then
bot.sendText(msg.chat_id,msg.id,"*⌔ 𓏺 عذراً يجب أنْ تكون مالك المجموعه فقط .*","md",true)  
return false
end
end
if redis:sismember(bot_id..":Groups",msg.chat_id) then
...
UserInfo = bot.getUser(msg.sender.user_id).first_name
bot.sendText(sudoid,0,'*\n⌔ 𓏺 تم تعطيل المجموعه التاليه : \n⌔ 𓏺 بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n⌔ 𓏺 معلومات المجموعه :\n⌔ 𓏺 عدد الاعضاء : '..Info_Chats.member_count..'\n⌔ 𓏺 عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔ 𓏺 عدد المطرودين : '..Info_Chats.banned_count..'\n⌔ 𓏺 عدد المقيدين : '..Info_Chats.restricted_count..'\n⌔ 𓏺 الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 تم تعطيل المجموعه بنجاح .*',"md",true, false, false, false, reply_markup)
redis:srem(bot_id..":Groups",msg.chat_id)
local keys = redis:keys(bot_id..'*'..'-100'..data.supergroup.id..'*')
redis:del(bot_id..":"..msg.chat_id..":Status:Creator")
redis:del(bot_id..":"..msg.chat_id..":Status:BasicConstructor")
...
bot.sendText(msg.chat_id,msg.id,'*⌔ 𓏺 المجموعه معطله بالفعل .*',"md", true)
end
end
----------------------------------------------------------------------------------------------------
end --- end Run
...
return bot.sendText(sudoid,0,'⌔ 𓏺 تم طرد البوت من مجموعه جديده\n⌔ 𓏺 معلومات المجموعه :\n⌔ 𓏺 الايدي : ( -100'..data.supergroup.id..' )\n*⌔ 𓏺 عدد الاعضاء : '..Info_Chats.member_count..'\n⌔ 𓏺 عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔ 𓏺 عدد المطرودين : '..Info_Chats.banned_count..'\n⌔ 𓏺 عدد المقيدين : '..Info_Chats.restricted_count..'\n⌔ 𓏺 الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md",true, false, false, false, reply_markup)
end
end
end
...
t = "⌔ 𓏺 تم حذف الامر بنجاح"
else
t = " ⌔ 𓏺 عذراً الامر  ( "..data.message.content.text.text.." ) غير موجود "
end
...
return bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*⌔ 𓏺 عليك الاشتراك في قناة البوت اولاً ! .*").yu,"md", true, false, false, false, reply_dev)
end
end
end
end
...
if hash then    
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*⌔ 𓏺 "..tu.." "..ut.." من المجموعه .*").yu,"md",true)  
end
end
...
if photo.total_count > 0 then
bot.sendPhoto(data.message.chat_id, data.message.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,"*⌔ 𓏺 اهلا بك في بوت الحمايه\n⌔ 𓏺 وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n⌔ 𓏺 لتفعيل البوت ارسل كلمه *تفعيل", 'md', nil, nil, nil, nil, nil, nil, nil, nil, nil, kup)
else
bot.sendText(data.message.chat_id,data.message.id,"*⌔ 𓏺 اهلا بك في بوت الحمايه \n⌔ 𓏺 وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n⌔ 𓏺 لتفعيل البوت ارسل كلمه *تفعيل","md",true, false, false, false, kup)
end
end
end
end
...
if hash then    
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⌔ 𓏺 "..tu.." "..ut.." من المجموعه .*").yu,"md",true)  
end
end
Run(msg,data)
...
if #lsme == 0 then
t = "*⌔ 𓏺 لا يوجد مشرفين في المجموعه .*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
end
