...
type = 'inline',
data = {
{{text = '𓏺 𝖦𝗋𝗈𝗎𝗉 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 .',url="t.me/ourFREE"}},
}
}
...
{{text = '⌔︰ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "فري"),data="delnamebot"}},
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔︰ Press here .',url="t.me/sSs_BoT"}},
}
}
...
{{text = '⌔︰ 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/ourFREE"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𓏺 𝖦𝗋𝗈𝗎𝗉 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 .',url="https://t.me/ourFREE"}},
}
}
...
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/musicallybyfree/"..math.random(2,417).."&caption="..URL.escape("⌔︰ تم اختيار الاغنيه لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
